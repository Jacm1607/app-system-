    ...
    <div class="py-4">
        <div class="w-full mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                ...
                <!--    <div class="mb-6">-->
                <!--        <h1 class="text-2xl text-gray-700">Listas de Productos</h1>-->
                <!--        <hr>-->
                <!--    </div>-->
                <!--    <div class="">-->
                <!--        <a class="p-2 bg-green-700 text-white rounded-xl uppercase text-xs font-bold" href="{{ route('producto.create') }}">Crear producto</a>-->
                <!--    </div>-->
                <!--</div>-->
                <!--<form action="" method="get" class="w-full flex items-end">-->
                <!--    <div class="w-1/4">-->
                <!--        <x-jet-label for="producto" value="Buscar" />-->
                <!--        <x-jet-input id="producto" class="block mt-1 w-full" type="text" name="producto" placeholder="Buscar por nombre"-->
                ...
                <div class="">
                    ...
                    <div class="flex justify-center w-full px-6">
                        <div class="w-1/2">
                            <a class="inline-flex items-center px-4 py-2 bg-green-500 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-green-700 active:bg-green-900 focus:outline-none focus:border-green-900 focus:ring focus:ring-green-300 disabled:opacity-25 transition ml-4 p-2" href="{{ route('producto.create') }}">Crear
                                producto</a>
                        </div>
                        <div class="w-1/2">
                            <form action="" method="get" class="w-full flex items-end">
                                <div class="w-full">
                                    <x-jet-input id="producto" class="block w-full h-[35px] text-black" type="text" name="producto" placeholder="Buscar por nombre"
                                        :value="old('producto')" autofocus />
                                </div>
