            ...
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                <div class="">
                    <div class="w-full bg-gray-200 text-black text-center p-2">
                        <h1 class="text-2xl text-gray-700">Crear venta</h1>
                    </div>
                </div>
                    ...
                    <div class="grid grid-cols-6 gap-8">
                        <div class="col-span-6">
                            <div class="flex justify-between">
                                <div class="w-1/3">
                                    <p>
                                        <label class="text-gray-700" for="id_cliente">Cliente</label>
                                    </p>
                                    <p>
                                        <select class="w-full px-3 h-[45px] rounded-xl text-gray-700" name="id_cliente" id="id_cliente">
                        ...
                        <livewire:agregar-item /> 
                    </div>
                    <livewire:tabla-detalle-venta />
