            ...
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                <div class="">
                    <div class="mb-6 w-full bg-gray-200 text-black text-center p-2">
                        <h1 class="text-2xl text-gray-700">Listas de Ventas</h1>
                    </div>
                    <div class="flex justify-center w-full px-6">
                        <div class="w-1/2">
                            <a class="inline-flex items-center px-4 py-2 bg-green-500 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-green-700 active:bg-green-900 focus:outline-none focus:border-green-900 focus:ring focus:ring-green-300 disabled:opacity-25 transition ml-4 p-2" href="{{ route('venta.create') }}">Crear
                                venta</a>
                        </div>
                        <div class="w-1/2">
                            <form action="" method="get" class="w-full flex items-end">
                                <div class="w-full">
                                    <x-jet-input id="venta" class="block w-full h-[35px] text-black" type="text" name="venta" placeholder="Buscar por número de venta"
                                        :value="old('venta')" autofocus />
                                </div>
                            ...
                            <div class="overflow-hidden">
                                <table class="min-w-full">
                                    <thead class="bg-white border-b">
                                        <tr>
                                            <th scope="col"
                                                class="text-sm font-bold text-gray-900 px-6 py-4 text-left"># Venta
                                            </th>
                                            <th scope="col"
                                                class="text-sm font-bold text-gray-900 px-6 py-4 text-left">Cliente</th>
                                            <th scope="col"
                                        ...
                                        @forelse ($ventas as $key => $venta)
                                            <tr>
                                                ...
                                                <td
                                                    ...
                                                    <a class="p-2 bg-blue-500 text-white rounded-xl" href="{{route('venta.show', $venta->id)}}"><i class="fa-solid fa-magnifying-glass"></i> Ver</a>
                                                    <a class="btn-eliminar p-2 bg-red-200 text-red-700 rounded-xl" href="{{ route('venta.delete', $venta->id) }}"><i class="fa-solid fa-trash"></i> Eliminar</a>
                                                </td>
                                            </tr>
                                        @empty
