            ...
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                ...
                <div class="">
                    ...
                    <div class="flex justify-center w-full px-6">
                        <div class="w-1/2">
                            <a class="inline-flex items-center px-4 py-2 bg-green-500 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-green-700 active:bg-green-900 focus:outline-none focus:border-green-900 focus:ring focus:ring-green-300 disabled:opacity-25 transition ml-4 p-2" href="{{ route('cliente.create') }}">Crear
                                cliente</a>
                        </div>
                        <div class="w-1/2">
                            <form action="" method="get" class="w-full flex items-end">
                                <div class="w-full">
                                    <x-jet-input id="cliente" class="block w-full h-[35px] text-black" type="text" name="cliente" placeholder="Buscar por razon social"
                                        :value="old('cliente')" autofocus />
                                </div>
                                    ...
                                    <thead class="bg-white border-b">
                                        <tr>
                                            ...
                                            <th scope="col"
                                                ...
                                                Social</th>
                                            <th scope="col"
                                                class="text-sm font-bold text-gray-900 px-6 py-4 text-left">NIT</th>
                                            <th scope="col"
                                        ...
                                        @forelse ($clientes as $cliente)
                                            <tr>
                                                ...
                                                <td
                                                    ...
                                                    <a class="p-2 bg-yellow-500 text-black rounded-xl" href="{{ route('cliente.edit', $cliente->id) }}">✏ Editar</a>
                                                    <a class="p-2 bg-red-200 text-red-700 rounded-xl" href="{{ route('cliente.delete', $cliente->id) }}">🗑 Eliminar</a>
                                                </td>
                                            </tr>
                                        @empty
