                                                ...
                                                @if(!is_null($cliente->cliente))
                                                    <tr>
                                                        ...
                                                        <td
                                                            ...
                                                            <a class="p-2 bg-yellow-500 text-black rounded-xl" href="{{ route('cliente.edit', $cliente->cliente->id) }}">✏ Editar</a>
                                                            <a class="btn-eliminar p-2 bg-red-200 text-red-700 rounded-xl" href="{{ route('cliente.delete', $cliente->cliente->id) }}">🗑 Eliminar</a>
                                                        </td>
                                                    </tr>
                                                @endif
                                            @empty
                                            ...
                                            @forelse ($clientes as $cliente)
                                                <tr>
                                                    ...
                                                    <td
                                                        ...
                                                        <a class="btn-eliminar p-2 bg-red-200 text-red-700 rounded-xl" href="{{ route('cliente.delete', $cliente->id) }}">🗑 Eliminar</a>
                                                    </td>
                                                </tr>
                                            @empty
                                                <td colspan="4" class="px-6 py-4">
