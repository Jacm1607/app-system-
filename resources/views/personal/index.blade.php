                                                ...
                                                @forelse ($personales as $personal)
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td
                                                            ...
                                                            <a class="p-2 bg-yellow-500 text-black rounded-xl" href="{{ route('personal.edit', $personal->id) }}">✏ Editar</a>
                                                            <a class="btn-eliminar p-2 bg-red-200 text-red-700 rounded-xl" href="{{ route('personal.delete', $personal->id) }}">🗑 Eliminar</a>
                                                        </td>
                                                    </tr>
                                                     @endif
                                                @empty
