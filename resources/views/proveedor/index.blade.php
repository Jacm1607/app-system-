                                        ...
                                        @forelse ($proveedores as $proveedor)
                                            <tr>
                                                ...
                                                <td
                                                    ...
                                                    <a class="p-2 bg-yellow-500 text-black rounded-xl" href="{{ route('proveedor.edit', $proveedor->id) }}"><i class="fa-solid fa-pencil"></i> Editar</a>
                                                    <a class="btn-eliminar p-2 bg-red-200 text-red-700 rounded-xl" href="{{ route('proveedor.delete', $proveedor->id) }}"><i class="fa-solid fa-trash"></i> Eliminar</a>
                                                </td>
                                            </tr>
                                        @empty
