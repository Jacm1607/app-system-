        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg p-6">
                <div class="flex justify-between">
                    <div class="mb-6">
                        <h1 class="text-2xl dark:text-gray-700">Actualizar Area</h1>
                        <hr>
                    </div>
                    <div class="">
                ...
                <form method="POST" action="{{ route('area.update', $area->id) }}" class="forms-sample">
                    ...
                    <div class="grid grid-cols-4">
                        <div class=" col-span-1">
                            ...
                            <p>
                                <input type="text" class="w-full rounded-xl dark:text-gray-700" id="nombre_area" name="nombre"  value="{{$area->nombre}}"
