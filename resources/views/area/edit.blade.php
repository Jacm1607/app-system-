            ...
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
               <div class="">
                    <div class="w-full bg-gray-200 text-black text-center p-2">
                        <h1 class="text-2xl text-gray-700">Editar area </h1>
                    </div>
                </div>
                <form method="POST" action="{{ route('area.update', $area->id) }}" class="p-6">
                    @csrf
                    @method('put')
