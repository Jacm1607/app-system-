        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg p-6">
                <div class="flex justify-between">
                    ...
                    <div class="">
                        <a class="p-2 bg-green-700 text-white rounded-xl" href="{{ route('area.create') }}">Crear area</a>
                    </div>
                </div>
                                ...
                                <table class="min-w-full">
                                    ...
                                    <tbody>
                                        @forelse ($areas as $area)
                                            <tr>
                                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">{{ $area->nombre }}
                                                </td>
